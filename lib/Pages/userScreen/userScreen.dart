                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        SizedBox(height: 30),
                        userProfile(
                            userImage: "assets/images/userScreen/profile.png",
                            userId: this.ID,
                            userName: this.userName,
                            callback: (String value) => changename(
                                value)), // simply change here to change user image
                        ...
                        UserProfileInfo(
                            ...
                            user_id: this.ID,
                            callback: (String value) => changename(value)),
                      ],
                    ),
                  ),
                ],
                                ...
                                children: [
                                            ...
                                            child: TextButton(
                                              ...
                                              child: CircleAvatar(
                                                backgroundImage: AssetImage(
                                                    "assets/icons/userScreen/edit.png"),
                                                backgroundColor:
                                                    Color(0XFF80CBC4),
                                              ),
                                            ),
                                  ...
                                  ElevatedButton(
                                      onPressed: () {
                                        ...
                                        widget
                                            .callback(textControllers[0].text);
                                      },
                                      child: Text("Change",
              ...
              children: [
                Icon(
                  ...
                  color: Color.fromARGB(
                      0xFF, 0x7b, 0xd1, 0xc2), // change to primary
                  size:
